...
# Install in tenant
Install-NAVApp -ServerInstance DynamicsNAV110 -Name "SeminarModule"
# Uninstall the app - Delete the data
Uninstall-NAVApp  -ServerInstance DynamicsNAV110 -Name "SeminarModule" -DoNotSaveData 
# Remove the app from the database - but keep the tables
Unpublish-NAVApp -ServerInstance DynamicsNAV110 -Name "SeminarModule" 
